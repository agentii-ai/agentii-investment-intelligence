...
## What's-changed vectors & model-vs-consensus deltas (quarter review)

- **Three what's-changed vectors**: every review closes by slot-refreshing
...
- **Uncertainty discipline**: scenario-flexing stays at market level, POS at
  ...
  where a likelihood is unquantifiable.
