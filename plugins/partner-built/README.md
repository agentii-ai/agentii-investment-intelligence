...
domain-specific analytics, or specialized modeling tools (FR-048).
...
`partner_built: true` at v1.0 (FR-049).
...
- Editorial review (methodology soundness, citation discipline, FR-020a/b
