...
Follow the retrieval strategy decision tree in `retrieval.md`. This skill was upgraded from `structured_only` to `unstructured_document_search` scope (2026-06-03) to pull MD&A and risk-factor narrative context alongside XBRL multiples. This skill uses:
