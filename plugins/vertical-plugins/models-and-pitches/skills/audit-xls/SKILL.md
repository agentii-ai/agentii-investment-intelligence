---
name: audit-xls
description: 'Excel workbook audit: scan for hardcoded values in projection/margin/discount/PV/sensitivity
  cells, flag formula integrity issues.'
...
- analyze audit xls
- run audit xls analysis
- produce audit xls report
- audit xls breakdown
- audit xls deep dive
- build a audit xls
- assess audit xls
- quantify audit xls
- compare audit xls across peers
- review audit xls for
- generate audit xls on
- audit xls for investment decision
