...
description: Trade idea generation, qualitative and quantitative screening, catalyst identification, thematic idea sourcing, watchlist construction, idea funnel prioritization
multi_ticker_semantics: single_target
temporal_scope:
  default_quarters: 4
  max_quarters: 12
  description: "4 quarters default for trade-idea-generation analysis; up to 12 for regime context."
allowed_tools:
...
|-----------|---------------|-----------|
| lookback_quarters | 4 | Standard window for trade-idea-generation |
...
### Retrieval Strategy
Query knowledge entries for trade-idea-generation frameworks; query search_by_analogue for historical analogues.
...
### Protocol
1. Theme/catalyst mapping
2. Quantitative screen
3. Qualitative filter
4. Analogue retrieval
5. Idea ranking
