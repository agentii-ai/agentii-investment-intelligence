...
|-----------|---------------|-----------|
| lookback_quarters | 4 | Standard window for long-short-construction |
...
### Retrieval Strategy
Query knowledge entries for long-short-construction frameworks; query search_by_analogue for historical analogues.
