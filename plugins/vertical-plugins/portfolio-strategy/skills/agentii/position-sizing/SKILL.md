...
description: position sizing, Kelly criterion, risk budgeting, volatility targeting, portfolio allocation, bet sizing, capital allocation, drawdown management, position management, risk parity sizing
...
## Output File
`{ticker}/{YYYY-MM-DD_HHMM}_position-sizing_{affix}.md`
