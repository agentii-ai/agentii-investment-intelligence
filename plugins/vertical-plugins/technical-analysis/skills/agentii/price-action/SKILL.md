---
name: price-action
description: Price action analysis, market structure reading, trend and range identification, support resistance levels, candlestick pattern analysis, breakout and pullback setups, Brooks price action methodology
multi_ticker_semantics: single_target
temporal_scope:
  default_quarters: 4
  max_quarters: 12
  description: "4 quarters default for price-action analysis; up to 12 for regime context."
allowed_tools:
...
|-----------|---------------|-----------|
| lookback_quarters | 4 | Standard window for price-action |
...
### Retrieval Strategy
Query knowledge entries for price-action frameworks; query search_by_analogue for historical analogues.
