...
### Retrieval Strategy
Query knowledge entries for leading-indicators frameworks; query search_by_analogue for historical analogues.
...
### Protocol
1. Indicator panel review
2. Turning-point signal
