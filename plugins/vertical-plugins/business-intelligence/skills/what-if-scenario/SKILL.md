...
description: 'What-if scenario analysis: base/bull/bear case construction, sensitivity
  tables, and probability-weighted outcome assessment.'
...
- produce what if scenario report
- what if scenario breakdown
- what if scenario deep dive
- build a what if scenario
- assess what if scenario
- quantify what if scenario
- compare what if scenario across peers
- review what if scenario for
- generate what if scenario on
- what if scenario for investment decision
