---
name: operational-kpi-tracker
description: 'Operational KPI tracker: sector-specific metrics (DAU/MAU, ARR, gross
 bookings, orders shipped), sequential trend, and peer comparison.'
...
- analyze operational kpi tracker
- run operational kpi tracker analysis
- produce operational kpi tracker report
- operational kpi tracker breakdown
- operational kpi tracker deep dive
- build a operational kpi tracker
- assess operational kpi tracker
- quantify operational kpi tracker
- compare operational kpi tracker across peers
- review operational kpi tracker for
- generate operational kpi tracker on
- operational kpi tracker for investment decision
